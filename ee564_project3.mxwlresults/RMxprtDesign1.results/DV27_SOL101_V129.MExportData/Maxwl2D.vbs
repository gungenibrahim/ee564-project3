...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "Consider Mechanical Transient:=", true, "Angular Velocity:=", "618.198rpm", _
  "Moment of Inertia:=", 22.3973, "Damping:=", 0.596544, "Load Torque:=", _
  "if(speed<50.2655, -98.9522*speed, -250015/speed)", "Objects:=", Array(_
  "Band"))
